...
declare global {
  interface Window {
    YxkMeetExternalAPI: any;
  }
}

export interface YxkMeetAPI {
  // TODO, add definitions
}

export interface YxkMeetAPIOptions {
  roomName?: string;
...
export interface ConfigOptions {
  ...
  testing?: {
    ...
    /**
     * Enables the test specific features consumed by yxk-meet-torture
     */
    testMode?: boolean;
  ...
  /**
   * Enabling this will run the lib-yxk-meet no audio detection module which
  ...
  /**
   * Enabling this will run the lib-yxk-meet noise detection module which will
   ...
   * used by browsers that return true from lib-yxk-meet's
  ...
  dropbox?: {
     ...
     * 'https://yxk-meet.example.com/static/oauth.html'
     */
    redirectURI?: string;
  };
   ...
   * the webrtc stats) as it is done in the yxk-meet-torture bandwidth
   * estimation tests.
   */
  gatherStats?: boolean;
  ...
  analytics?: {
    ...
    /**
     * Array of script URLs to load as lib-yxk-meet "analytics handlers"
     * @example
     *  [
  ...
  /**
   * Information about the yxk-meet instance we are connecting to, including
  ...
  /**
     * List of undocumented settings used in yxk-meet:
  ...
  /**
     * List of undocumented settings used in lib-yxk-meet:
...
export interface InterfaceConfigOptions {
  ...
  SHOW_YXK_WATERMARK?: boolean;

  YXK_WATERMARK_LINK?: string;
  ...
  /**
   * Whether the mobile app Yxk Meet is to be promoted to participants
...
export interface Props {
  ...
  /**
   * Yxk iframe container styles
   */
  frameStyle?: React.CSSProperties;

  /**
   * Component shown until YxkMeet video conference is not started
   */
  loadingComponent?: React.ComponentType;

  /**
   * Callback function invoked with YxkMeetExternalAPI object when it is loaded
   */
  onAPILoad?: (api: YxkMeetAPI) => void;

  /**
   * Callback function invoked when YxkMeet iframe is loaded
   */
  onIframeLoad?: () => void;

  /**
   * Domain used to build the conference URL, 'hy.bjyixiu.com' for example.
   */
  domain?: string;
  ...
  // Options passed to YxkMeetExternalAPI
